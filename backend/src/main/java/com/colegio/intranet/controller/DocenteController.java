...
public class DocenteController {
    ...
    public ResponseEntity<List<Docente>> listar() {
        return ResponseEntity.ok(docenteRepository.findByActivoTrue());
    }
    ...
    public ResponseEntity<Docente> crear(@RequestBody Docente docente) {
        ...
        notificacionService.notificarARol(currentUser(), Usuario.Rol.DIRECTOR,
            ...
            "Se registró al docente " + (docente.getNombres() != null ? docente.getNombres() + " " : "") + (docente.getApellidos() != null ? docente.getApellidos() : ""),
            "INFO", "docente");
    ...
    public ResponseEntity<Docente> actualizar(@PathVariable Integer id, @RequestBody Docente docente) {
        ...
        notificacionService.notificarARol(currentUser(), Usuario.Rol.DIRECTOR,
            "Docente actualizado",
            "Se actualizó la información del docente " + (docente.getNombres() != null ? docente.getNombres() + " " : "") + (docente.getApellidos() != null ? docente.getApellidos() : ""),
            "INFO", "docente");
        return ResponseEntity.ok(saved);
    }
    ...
    public ResponseEntity<Void> eliminar(@PathVariable Integer id) {
        ...
        String nombreDocente = (docente.getNombres() != null ? docente.getNombres() + " " : "") + (docente.getApellidos() != null ? docente.getApellidos() : "");
        docente.setActivo(false);
        docenteRepository.save(docente);
        notificacionService.notificarARol(currentUser(), Usuario.Rol.DIRECTOR,
            "Docente desactivado",
            "Se desactivó al docente " + nombreDocente,
            "WARNING", "docente");
