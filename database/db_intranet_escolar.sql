...
-- 14. Notificaciones
INSERT INTO notificacion (usuario_emisor_id, usuario_receptor_id, titulo, mensaje, tipo, leido) VALUES
(3, 1, 'Carga de estudiantes', 'Solicito que se carguen los nuevos estudiantes en el sistema.', 'INFO', 0),
(1, 3, 'Estudiantes registrados', 'Ya están registrados, gracias por el aviso.', 'SUCCESS', 1);
...
SELECT '✅ Base de datos db_intranet_escolar creada exitosamente con todas las migraciones integradas' AS Resultado;