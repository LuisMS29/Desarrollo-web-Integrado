...
public class EstudianteController {
    ...
    public ResponseEntity<List<Estudiante>> listar() {
        return ResponseEntity.ok(estudianteRepository.findByActivoTrue());
    }
    ...
    public ResponseEntity<Estudiante> crear(@RequestBody Estudiante estudiante) {
        ...
        notificacionService.notificarARol(currentUser(), Usuario.Rol.DIRECTOR,
            ...
            "Se registró al estudiante " + (estudiante.getNombres() != null ? estudiante.getNombres() + " " : "") + (estudiante.getApellidos() != null ? estudiante.getApellidos() : ""),
            "INFO", "estudiante");
    ...
    public ResponseEntity<Estudiante> actualizar(@PathVariable Integer id, @RequestBody Estudiante estudiante) {
        ...
        notificacionService.notificarARol(currentUser(), Usuario.Rol.DIRECTOR,
            ...
            "Se actualizó la información del estudiante " + (estudiante.getNombres() != null ? estudiante.getNombres() + " " : "") + (estudiante.getApellidos() != null ? estudiante.getApellidos() : ""),
            "INFO", "estudiante");
        return ResponseEntity.ok(saved);
    }
    ...
    public ResponseEntity<Void> eliminar(@PathVariable Integer id) {
        ...
        String nombre = (estudiante.getNombres() != null ? estudiante.getNombres() + " " : "") + (estudiante.getApellidos() != null ? estudiante.getApellidos() : "");
        estudiante.setActivo(false);
        estudianteRepository.save(estudiante);
        notificacionService.notificarARol(currentUser(), Usuario.Rol.DIRECTOR,
            "Estudiante desactivado",
            "Se desactivó al estudiante " + nombre,
            "WARNING", "estudiante");
