...
@NgModule({
  declarations: [AdminDashboard, AdminUsuarios, AdminDocentes, AdminEstudiantes, AdminGrados, AdminSecciones, AdminAsignaturas, AdminCursos, AdminPeriodos, AdminComunicados],
