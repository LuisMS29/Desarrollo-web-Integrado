...
import { DocentePerfil } from './perfil/perfil';
...
@NgModule({
  declarations: [DocenteDashboard, DocenteMisCursos, DocenteMisEstudiantes, DocenteComunicados, DocenteNotas, DocenteAsistencia, DocenteMiHorario, DocentePerfil],
