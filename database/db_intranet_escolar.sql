...
(1, 'admin', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'admin@colegio.edu.pe', 'ADMIN', 1),
(2, 'director', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'director@colegio.edu.pe', 'DIRECTOR', 1),
(3, 'juanperez', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'jperez@colegio.edu.pe', 'DOCENTE', 1),
(4, 'marialopez', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'mlopez@colegio.edu.pe', 'DOCENTE', 1),
(5, 'carlosgarcia', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'cgarcia@colegio.edu.pe', 'DOCENTE', 1),
(6, 'anatorres', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'atorres@colegio.edu.pe', 'DOCENTE', 1),
(7, 'luiscastillo', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'lcastillo@alumno.edu.pe', 'ESTUDIANTE', 1),
(8, 'mariavelarde', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'mvelarde@alumno.edu.pe', 'ESTUDIANTE', 1);

-- 6. Docentes
INSERT INTO docente (id_docente, codigo_docente, nombres, apellidos, dni, especialidad, telefono, email, usuario_id) VALUES
(1, 'DOC001', 'Juan Carlos', 'Pérez García', '12345678', 'Matemática', '987654321', 'jperez@colegio.edu.pe', 3),
(2, 'DOC002', 'María Elena', 'López Quispe', '23456789', 'Comunicación', '987654322', 'mlopez@colegio.edu.pe', 4),
(3, 'DOC003', 'Carlos Alberto', 'García Torres', '34567890', 'Inglés', '987654323', 'cgarcia@colegio.edu.pe', 5),
(4, 'DOC004', 'Ana María', 'Torres Ríos', '45678901', 'Educación Física', '987654324', 'atorres@colegio.edu.pe', 6);

-- 7. Estudiantes
INSERT INTO estudiante (id_estudiante, codigo_estudiante, nombres, apellidos, dni, fecha_nacimiento, direccion, telefono, usuario_id) VALUES
(1, 'EST001', 'Luis Fernando', 'Castillo Farro', '11111111', '2020-05-15', 'Av. Los Olivos 123', NULL, 7),
(2, 'EST002', 'María José', 'Quispe Sulca', '22222222', '2020-07-21', 'Jr. Las Flores 456', NULL, NULL),
(3, 'EST003', 'Juan Carlos', 'Pérez Tupayachi', '33333333', '2020-09-10', 'Calle Real 789', NULL, NULL),
(4, 'EST004', 'Ana Paula', 'Tupayachi Carmen', '44444444', '2020-11-30', 'Av. Brasil 321', NULL, NULL),
(5, 'EST005', 'Pedro Pablo', 'Arbi Pando', '55555555', '2020-03-05', 'Pasaje Los Cedros 654', NULL, NULL),
(6, 'EST006', 'María Fernanda', 'Velarde Ochoa', '66666666', '2019-06-18', 'Av. La Marina 987', '987654325', 8),
(7, 'EST007', 'José Antonio', 'Marcaquispe Sulca', '77777777', '2019-08-22', 'Jr. Los Sauces 111', NULL, NULL);
