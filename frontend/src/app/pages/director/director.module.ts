...
@NgModule({
  declarations: [DirectorDashboard, DirectorDocentes, DirectorEstudiantes, DirectorGrados, DirectorSecciones, DirectorAsignaturas, DirectorCursos, DirectorHorarios, DirectorPeriodos, DirectorEvaluaciones, DirectorMatriculas, DirectorComunicados],
